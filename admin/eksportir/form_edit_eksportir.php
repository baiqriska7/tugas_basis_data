...
<a href="data_transaksi.php">Data Transaksi</a>
 ...
 <br>
 <button type="button" style="width: 10%;background-color:red"><a href="
data_eksportir.php"> Kembali</a></button>
<form action="simpan_edit_eksportir.php" method="post">
 <div class="container" style="width: 30%;">
<input type="hidden" value="<?php echo $row['id'];?>">
<label for="uname"><b>Nama Eksportir</b></label>
 <input type="text" name="nama_eksportir" required value="<?php echo $row['
nama_eksportir'];?>">
